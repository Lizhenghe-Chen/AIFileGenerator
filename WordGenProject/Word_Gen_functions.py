...
from Word_Prompt import get_word_generation_prompt
...
def call_openai_api(prompt: str) -> str:
    ...
    try:
        ...
        response = client.chat.completions.create(
            ...
            messages=[
                {"role": "system", "content": "你是一个专业的教育内容生成助手，擅长创建高质量的教学材料。"},
...
def generate_document_content(user_input: str) -> Dict[str, Any]:
    """
    根据用户输入生成文档内容
...
def create_word_document(context_data: Dict[str, Any], output_filename: str) -> str:
    ...
    try:
        ...
        template_path = os.path.join(
            os.getcwd(), 
            WORD_CONFIG["template_folder"], 
            WORD_CONFIG["default_template"]
        )
...
def generate_word_from_user_input(
    user_input: str, 
    ...
    try:
        # 1. 生成文档内容
        parsed_data = generate_document_content(user_input)
